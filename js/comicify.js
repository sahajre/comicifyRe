...
var Comic = {
	...
	drawFullHorizontalLine: function (context, from_y, to_x) {
		Comic.drawLine(context, 0, from_y, to_x, from_y);
	},

	drawLine: function (context, from_x, from_y, to_x, to_y) {
		context.beginPath();
	...
	drawHeader: function (context, strip_element) {
		...
		if( header != null ) {
			...
			Comic.drawFullHorizontalLine(context, 20, width);
		}
	},

	drawFooter: function (context, strip_element) {
		...
		if( footer != null ) {
			...
			Comic.drawFullHorizontalLine(context, height - 20, width);
		}
	},

	drawDialogue: function (context, strip_element) {
	...
	drawBackground: function (context, strip_element) {
		...
		if( background != null) {
			...
			if(background_img != null) {
				...
				img.onload = function () {
					...
					Comic.drawHeader(context, strip_element);
					Comic.drawFooter(context, strip_element);
					//drawEllipse(context, 90, 40, 180, 100); 
					Comic.drawDialogue(context, strip_element);
				}
			}
		}
	},

	drawEllipse: function (context, rectx0, recty0, rectx1, recty1) {
	...
	makeStrip: function (strip_id, strip_element) {
		//alert(strip_id);
		...
		Comic.drawBackground(context, strip_element);
		...
		$(document).ready(function(){
			...
			$(".comic").each( function() {
				...
				$(this).find(".strip").each( function() {
					...
					Comic.makeStrip(strip_id, strip_element);
